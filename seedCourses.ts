import { collection, addDoc, getDocs, query, where, db } from './firebase';
...
// Run this function to seed the courses
// You can call this from the browser console or create a button in the admin panel
