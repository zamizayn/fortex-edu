            ...
            <div className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-white pt-24 md:pt-32">
                <div className="absolute inset-0 z-0">
                    ...
                    <motion.img
                        ...
                        src={siteSettings?.collegesHeroBanner || "https://images.unsplash.com/photo-1562774053-701939374585?q=80&w=2086&auto=format&fit=crop"}
                        alt="Colleges Hero"
                                ...
                                <div className="lg:sticky lg:top-32 space-y-10">
                                    ...
                                    <div className="p-6 bg-gray-100 rounded-lg text-gray-900 flex flex-col items-center justify-center text-center">
                                        ...
                                        <div className="text-4xl font-bold">
                                            {selectedLocation === 'All' ? colleges.length : colleges.filter(c => c.location === selectedLocation).length}
                                        </div>
                                    </div>
                                </div>
                            </aside>
                                            ...
                                            <div className="flex flex-col flex-grow">
                                                ...
                                                <div className="pt-6 border-t border-slate-50 mt-auto">
                                                    <div className="flex gap-3">
                                                        <a
                                                            href={`https://wa.me/${siteSettings?.whatsappNumber?.replace(/\D/g, '') || ''}?text=${encodeURIComponent(`Hello, I would like admission details for ${college.name}.`)}`}
                                                            target="_blank"
