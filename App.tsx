    ...
    <Router>
      <div className="relative min-h-screen font-sans selection:bg-blue-100 selection:text-blue-900 overflow-x-hidden">
        ...
        <a
          ...
          className="fixed bottom-8 right-8 bg-green-500 text-white p-5 rounded-full shadow-2xl hover:bg-green-600 hover:scale-110 transition-all z-40 flex items-center justify-center group min-w-[64px] min-h-[64px]"
          aria-label="Contact on WhatsApp"
        >
          <span className="absolute right-full mr-4 bg-white text-gray-900 px-4 py-2.5 rounded-lg text-sm md:text-base font-medium shadow-xl whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
            Need Help? Chat Now
          </span>
